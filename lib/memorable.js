...
(function() {
  ...
  Memorable = (function() {
    ...
    function Memorable(key, data, options) {
      ...
      if ((_ref1 = options.nearDeath) == null) {
        options.nearDeath = 0;
      }
      this.key = key;
      this.data = data;
      ...
      this.nearDeath = options.nearDeath;
      this.size = this.calculateSize();
    }

    Memorable.prototype.isGood = function() {
      return !this.invalid || this.expires === 0 || this.time.now < this.expires;
    };

    Memorable.prototype.isNearDeath = function() {
      return this.time.now > (this.expires - (DeathTime * 1000));
    };
